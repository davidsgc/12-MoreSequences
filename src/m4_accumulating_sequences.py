...
def run_test_make_simple_list():
    ...
    expected = [53, 54, 55, 56, 57, 58, 59, 60]
    actual = make_simple_list(53, 60)
    print('Expected:', expected)
    print('Actual:  ', actual)

    #Test 3:
    expected = [100, 101, 102, 103, 104]
    actual = make_simple_list(100, 104)
    print('Expected:', expected)
    print('Actual:  ', actual)
...
def run_test_make_simple_string():
    ...
    #Test 1
    expected = '100-101-102-103-104-'
    actual = make_simple_string(100, 104)
    print('Expected:', expected)
    print('Actual:  ', actual)
...
def run_test_make_less_simple_string():
    ...
    #Test 1
    expected = '100-101-102-103-104'
    actual = make_less_simple_string(100, 104)
    print('Expected:', expected)
    print('Actual:  ', actual)

    #Test 2
    expected = '1-2-3-4-5-6-7'
    actual = make_less_simple_string(1, 7)
    print('Expected:', expected)
    print('Actual:  ', actual)

    #Test 3
    expected = 200
    actual = make_less_simple_string(200, 200)
    print('Expected:', expected)
    print('Actual:  ', actual)
